...
import { notcoin, rocket, bear, coin, highVoltage, trophy } from './images';
...
function App() {
  ...
  return (
    <div className="bg-gradient-main min-h-screen px-4 flex flex-col items-center text-white font-medium">
      ...
      <div className="absolute insert-0 h-1/2 bg-gradient-overlay z-0"></div>
      <div className="absolute insert-0 flex items-center justify-center z-0">
      ...
      <div className="w-full z-10 min-h-screen flex flex-col items-center text-white">
        ...
        <div className="fixed top-0 left-0 w-full px-4 pt-8 z-10 flex flex-col items-center text-white">
          <div className="w-full cursor-pointer">
            <div className="bg-[#edeff19d] text-center py-2 rounded-xl">
        ...
        <div className="fixed bottom-0 left-0 w-full px-4 pb-4 z-10">
          ...
          <div className="w-full bg-[#fad65ccc] rounded-full mt-4">
